...
declare module 'nitropack' {
  ...
  interface InternalApi {
    '/api/healthz': Awaited<ReturnType<typeof import('../../server/api/healthz.get').default>>
    '/api/example': Awaited<ReturnType<typeof import('../../server/api/example/index').default>>
    '/api/example/:id': Awaited<ReturnType<typeof import('../../server/api/example/[id].patch').default>> | Awaited<ReturnType<typeof import('../../server/api/example/[id].get').default>>
